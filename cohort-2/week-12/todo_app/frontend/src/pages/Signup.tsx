...
export default function Signup() {
    ...
    function signup() {
        axios.post('http://localhost:3021/api/v1/user/signup', {
            username,
            password
        })
            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" action="#" method="POST">
                        ...
                        <div>
                            <button onClick={signup} type="button" className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign up</button>
                        </div>
                    </form>
                </div>
            </div>
